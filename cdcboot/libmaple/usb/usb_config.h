...
#elif defined(BOARD_STBee) || defined(BOARD_STBee2)

    #define VCOM_ID_VENDOR       0x0483 
    #define VCOM_ID_PRODUCT      0x5740
...
#define VCOM_RX_BUFLEN            256	// must be power of Two
