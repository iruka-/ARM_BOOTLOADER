...
#define	SAMPLING_SIZE	32		//(PACKET_SIZE*18)
char	sampling_buf[SAMPLING_SIZE];
...
void make_dummy(char *buf,int size)
{
	static int data=0;
	ushort *p=(ushort *)buf;
	int i;
