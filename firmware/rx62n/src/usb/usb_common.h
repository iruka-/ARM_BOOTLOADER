...
#define DEBUG_LEVEL 	DEBUG_LEVEL_NONE	//DEBUG_LEVEL_LOW	////////////////////(n.k)
...
/*Only allow debug messages in a debug build*/
		...
		#define DEBUG_MSG_HIGH(x) sci_printf x	//printf x
	#else
		#define DEBUG_MSG_HIGH(x)
	#endif

	#if DEBUG_LEVEL >= DEBUG_LEVEL_MID
		#define DEBUG_MSG_MID(x) sci_printf x	//printf x
	#else
		#define DEBUG_MSG_MID(x)
	#endif

	#if DEBUG_LEVEL >= DEBUG_LEVEL_LOW
		#define DEBUG_MSG_LOW(x) sci_printf x	//printf x
	#else
