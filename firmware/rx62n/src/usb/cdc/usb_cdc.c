...
USB_ERR USBCDC_WriteString(const char* const _sz)
{
	...
	err = USBCDC_Write(NumBytes, (uint8_t*)_sz);
...
* Return value  : Error code.
**********************************************************************/
USB_ERR USBCDC_Write(uint32_t _NumBytes, uint8_t* _Buffer)
{
	USB_ERR err = USB_ERR_OK;
...
* Return value  : Error Code.
**********************************************************************/
USB_ERR USBCDC_Write_Async(uint32_t _NumBytes, uint8_t* _Buffer, CB_DONE _cb)
{
	USB_ERR err = USB_ERR_OK;
