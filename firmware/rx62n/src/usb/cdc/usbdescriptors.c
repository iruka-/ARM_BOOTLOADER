...
static const uint8_t gDeviceDescriptorData[DEVICE_DESCRIPTOR_SIZE] = 
{
	...
	(uint8_t)( VENDOR_ID 	& 0xFF),	/*Vendor ID LSB*/
	(uint8_t)((VENDOR_ID>>8)& 0xFF),	/*Vendor ID MSB*/
	(uint8_t)( PRODUCT_ID 	& 0xFF),	/*Product ID LSB*/
	(uint8_t)((PRODUCT_ID>>8)& 0xFF),	/*Product ID MSB*/
